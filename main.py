...
def notify_about_new_apartments(email: str | list[str], filter_func: Callable | None = None):
    ...
    new_listings = owme.get_listings()
    if filter_func:
...
if __name__ == '__main__':
    notify_about_new_apartments([gmail.EMAIL, LUIZA_EMAIL])
